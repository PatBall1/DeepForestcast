...
checkpoint = (
    modelpath
    + "/torch.nn.parallel.data_parallel.DataParallel/torch.nn.parallel.data_parallel.DataParallel_17.9.19_7.53_547402[10].pbs.pt"
)
...
np.savetxt(
    "/rds/general/user/jgb116/home/repos/deforestation_forecasting/data/Hansen/heatmaps/"
    + modelname
    + "_forecast_from_outputs.csv",
