...
if __name__ == "__main__":
    ...
    if not (
        os.path.isfile(wherepath + "/" + "Train3Da_idx%d.npy" % (end_year))
        & os.path.isfile(wherepath + "/" + "Test3Da_idx%d.npy" % (end_year))
    ):
    ...
    print(
        "\tTrain and Test ratios of 0:1 labels: 1:%d ; 1:%d "
    ...
    summary = (
        f"| Job:{job:d}" + " | Model:" + name + f" | Best epoch:{best_epoch+1:d} |"
    )
